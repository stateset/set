...
export const agentPaymentAccountV2Abi = [
  ...
  "function INVOICE_TYPEHASH() view returns (bytes32)",
  "function invoiceDigest(bytes32 orderId, address merchant, uint256 assets, uint40 deadline) view returns (bytes32)",
  "function pay(bytes32 orderId, uint256 epoch, uint256 nonce, uint256 assets, uint256 maxShares, uint40 deadline, bytes merchantSignature) returns (uint256 shares)",
